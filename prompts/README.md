...
Before writing any code, interview me to clarify requirements. Ask one question at a time.
```
...
Decide the skill name for me and explain why.
```
...
```
#「請根據 Claude code best practices 實現規格書」

Implement the spec in SPEC.md following Claude Code best practices.

Read the spec, produce a gap analysis, then implement phase by phase.
```

```
# 「讓 Claude Code 先做 gap analysis，再產生 implementation plan」
